...
@Module({
  ...
  providers: [PersonService, PassengerService, RouteService, StationsService, PaymentMethodService],
  exports: [PersonService, PassengerService, RouteService, StationsService, PaymentMethodService],
})
